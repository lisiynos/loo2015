...
long long ft(long long index, long long x) {
    if (index == 1) {
        if (t1[x] != -1);
            ...
            if (b[x][1]) t1[x] = (ft(2, x) % h);
            else {
                if (b[x][2]) t1[x] = (ft(4, x) % h);
                else {
                    if (b[x + 1][1])
    ...
    if (index == 3) {
        if (t3[x] != -1);
            ...
            if (b[x][2]) t3[x] = (ft(2, x + 1) % h);
            else {
                if (b[x + 1][2]) t3[x] = (ft(1, x + 2) % h);
                else {
    ...
    if (index == 4) {
        if (t4[x] != -1);
            ...
            if (b[x][1]) t4[x] = (ft(1, x + 1) % h);
            else {
                if (b[x + 1][1]) t4[x] = (ft(2, x + 1) % h);
                else {
